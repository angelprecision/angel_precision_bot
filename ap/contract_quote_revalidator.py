...
def fetch_direct_option_quote_with_meta(
    ...
    *,
    ...
    # Invalid provider observations are failure evidence for this attempt, not
    # cacheable market truth. Caching one would suppress a fresh provider read
    # for the TTL and starve selector recovery after the feed heals.
