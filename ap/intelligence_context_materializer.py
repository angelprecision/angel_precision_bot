...
def _build_breach_evidence(
    ...
    return {
        ...
        "raw_pattern": signal.get("pattern") or signal.get("pattern_id"),
        "canonical_strategy_pattern": (
            signal.get("canonical_strategy_pattern")
            or signal.get("canonical_pattern")
            or signal.get("strategy_pattern")
        ),
        "trigger_crossed_at_provenance": signal.get("trigger_crossed_at_provenance"),
        "breach_lineage": signal.get("breach_lineage") or "UNKNOWN",
