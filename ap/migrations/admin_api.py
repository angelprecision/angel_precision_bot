# ap/admin_api.py
"""
Admin API endpoints for managing clients
Requires X-Admin-Key header
"""
from flask import Blueprint, jsonify, request
from ap.auth import require_admin_auth
from ap.client_manager import (
    create_new_client,
    list_all_clients,
...
def create_client_endpoint():
    ...
    Body:
    {
        ...
        "tradier_base_url": "https://api.tradier.com",  # or sandbox
...
def update_client_status_endpoint(client_id):
    ...
    try:
        ...
        client = update_client_status(client_id, status)
...
def regenerate_key_endpoint(client_id):
    ...
    try:
        ...
        log.error(f"Regenerate API key failed: {e}")
        return jsonify({"ok": False, "error": str(e)}), 500
