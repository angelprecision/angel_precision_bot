...
REASON_CODES = {
    ...
    "CONTRACT": [
        "NO_CHAIN_DATA", "CHAIN_EMPTY", "CHAIN_FETCH_FAILED", "QUOTE_FETCH_FAILED",
        "QUOTE_ZERO_BID_ASK", "DIRECT_QUOTE_ZERO_BID_ASK", "CHAIN_ROW_ZERO_BID_ASK",
        "BID_BELOW_MIN", "NO_VALID_PLAYBOOK_DTE_CONTRACT",
        "NO_VALID_EXPIRY", "NO_ATM_STRIKE", "SPREAD_TOO_WIDE",
