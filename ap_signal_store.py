diff --git a/ap_signal_store.py b/ap_signal_store.py
new file mode 100644
index 0000000000000000000000000000000000000000..a22899668fb7acec36fad0461ee1fb291d59b10d
--- /dev/null
+++ b/ap_signal_store.py
@@ -0,0 +1,81 @@
...
+        }
+
+        self._fire(lambda: self.sb.table("ap_signals").insert(payload).execute(), "insert_signal")
+
...
+        self._fire(lambda: self.sb.table("ap_signal_option_outcomes").upsert(row).execute(), "option_outcome")
+
