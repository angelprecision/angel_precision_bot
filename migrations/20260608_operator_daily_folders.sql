...
-- 2. weekly_rollups
-- ---------------------------------------------------------------------------
-- Aggregated from operator_daily_folders. Recomputable: rerunning the
-- weekly rollup for an iso_week upserts this row. Never the source of
-- truth for trading; archive/reporting only.
-- ---------------------------------------------------------------------------
