        ...
        _Broker(
            {
                ...
                "exec_quantity": 1,
                "avg_fill_price": 1.05,
                "filled_ts": "2026-08-12T18:20:27.123456+00:00",
            }
        ),
        order,
    )
...
def test_transaction_date_only_cannot_authorize_exit_fill(monkeypatch):
    from ap import fill_monitor as fm
...
def test_conflicting_broker_fill_timestamps_hold_before_osm(monkeypatch):
    from ap import fill_monitor as fm
        ...
        _Broker(
            {
                ...
                "avg_fill_price": 1.05,
                "filled_ts": "2026-08-12T18:20:27.123456+00:00",
                "filled_at": "2026-08-12T18:20:28.123456+00:00",
            }
        ),
        order,
    )
