...
def test_broker_import_persists_proven_entry_identity_and_is_idempotent(production_db):
    """A broker-open import persists proven ENTRY IDs and installs one owner."""
    ...
    # A second import pass converges without another row or broker mutation.
