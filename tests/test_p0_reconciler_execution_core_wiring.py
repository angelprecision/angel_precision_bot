...
def test_reconciler_routes_submit_intent_to_real_recovery_consumer(
    ...
    class _Broker:
        ...
        def __getattr__(self, name):
            ...
            def _unexpected_call(*args, **kwargs):
                ...
                raise AssertionError(f"broker mutation called during reconciliation: {name}")
            ...
            or [
                {
                    ...
                    "submitted_ts": None,
                    "signal_id": "signal-submit-intent",
